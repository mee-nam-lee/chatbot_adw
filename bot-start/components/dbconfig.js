...
module.exports = {
    ...
    //connectString : process.env.NODE_ORACLEDB_CONNECTIONSTRING || "ORCLPDB1",
  //  connectString : process.env.NODE_ORACLEDB_CONNECTIONSTRING || "localhost:32769/ORCLPDB1.localdomain",
    ...
    //"(DESCRIPTION=(ADDRESS=(PROTOCOL=TCP)(HOST=mymachine.example.com)(PORT=1521))(CONNECT_DATA=(SERVER=DEDICATED)(SERVICE_NAME=orcl)))"
